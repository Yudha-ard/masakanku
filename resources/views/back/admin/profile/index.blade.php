                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        <form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="row">
                                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2 mb-3 mb-lg-0">@if($users->is_admin) admin @else user @endif</span>
                                            <div class="fv-plugins-message-container invalid-feedback"></div></div>  
                                        </div>
                                    </div>
                            ...
                            @if (Auth::user()->is_admin == 1)
                                <a href="{{ route('admin.profile.edit') }}" class="btn btn-primary" id="kt_account_profile_details_submit">Edit Profile</a>
                            @else
                                <a href="{{ route('user.profile.edit') }}" class="btn btn-primary" id="kt_account_profile_details_submit">Edit Profile</a>
                            @endif
                            </div>
