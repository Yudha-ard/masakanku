                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        ...
                        @endif
                            @if(Auth::user()->is_admin)
                                <form method="POST" action="{{ route('admin.profile.update') }}" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                            @else
                                <form method="POST" action="{{ route('user.profile.update') }}" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                            @endif
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                @if (Auth::user()->is_admin == 1)
                                    <a href="{{ route('admin.profile') }}" class="btn btn-light btn-active-light-primary me-2" id="kt_account_profile_details_submit">Back</a>
                                @else
                                    <a href="{{ route('user.profile') }}" class="btn btn-light btn-active-light-primary me-2" id="kt_account_profile_details_submit">Back</a>
                                @endif
